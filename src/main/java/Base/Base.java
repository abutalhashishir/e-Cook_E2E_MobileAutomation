...
public class Base {
    ...
    public DesiredCapabilities setAppCapabilitiesAndroid() {
        ...
        cap.setCapability("adbExecTimeout", 300000);
        cap.setCapability("appPackage", "com.riseuplabs.ecook");
        cap.setCapability("appActivity", "com.riseuplabs.ecook.MainActivity");	
